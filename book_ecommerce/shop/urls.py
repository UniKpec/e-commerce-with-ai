from .views import RegisterView,YayinciView,LoginView,LogInYayinci,KitapOlusturmaView,LogOutView,SepetEkeleme,SepetiListeleView,SatinAlView,SepettenVeriSilme,KitapListelemeView,KitapDetayView
